    ...
    def render(self):
        ...
        match self._currentScreen:
            case 'main_menu':
                ...
                pygame.draw.rect(SCREEN, (61, 61, 61), ((SCREEN.get_width()//2)-200, 200, 400, 100))
                SCREEN.blit(btnPlay, ((SCREEN.get_width()//2)-60, 210))
               
                # Render exit
                btnExit = btnFont.render("Exit!", False, (125, 125 ,125))
                pygame.draw.rect(SCREEN, (61, 61, 61), ((SCREEN.get_width()//2)-200, 400, 400, 100))
